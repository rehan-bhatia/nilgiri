      ...
      vero eos et accusam et justo duo dolores et ea rebum.</h1>
		      ...
		      vero eos et accusam et justo duo dolores et ea rebum.</h1>
					  ...
					  <ScrollAnimation animateIn="fadeInRight" duration="3">
						  <img src="http://mrmrs.github.io/photos/u/011.jpg" alt="student body" style={{"height":"auto", "width":"600px", "transform": "rotateZ(5deg)", "margin-bottom":"80px", "margin-left":"5vw", "margin-top":"100px"}}/>
					  </ScrollAnimation>
				  </div>
			  </BrowserView>
			  <MobileView>
				  <div>
					  <ScrollAnimation animateIn="fadeInLeft" duration="2">
						  <div style={{"padding-top":"40px", "margin-top":"80px", "margin-left":"50px", "margin-right":"20px"}}>
						  	<h1 className="f1"> The Student Body </h1>
						  	<h1 className="f2">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod
		      tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At
		      vero eos et accusam et justo duo dolores et ea rebum.</h1>
		     				 <p class="grow no-underline pointer br-pill ph3 pv2 mb2 mt3 dib white bg-dark-blue mt3" style={{"font-size":"18px"}} onClick={()=>this.props.onRouteChange('stu')}>Meet the Nilbulls</p>
						  </div>
					  </ScrollAnimation>
					  <ScrollAnimation animateIn="fadeInRight" duration="3">
						  <img src="http://mrmrs.github.io/photos/u/011.jpg" alt="student body" style={{"height":"auto", "width":"600px", "transform": "rotateZ(5deg)", "margin-bottom":"80px", "margin-left":"5vw", "margin-top":"50px"}}/>
					  </ScrollAnimation>
				  </div>
			  </MobileView>
			  <div>
