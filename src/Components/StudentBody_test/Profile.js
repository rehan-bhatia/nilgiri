...
const Profile = ({input}) => {
	return(
		<div class="fl w-50 w-25-m w-20-l pa2" style={{"min-width":"300px"}}>
		    <img src={`https://www.robohash.org/${input}`} alt="name" class="dim br-100 pa1 ba b--black-10" style={{"height":"300px","width":"300px"}}/>	     	      
			...
			<footer class="pv4 ph3 ph5-ns tc" style={{"margin-top":"0px", "margin-bottom":"30px"}}>
			  ...
			  <a class="link near-black dim hover-silver dib h2 w2 mr3" href="email" title="Mail">
			  	<img src="https://image.flaticon.com/icons/png/512/95/95645.png" style={{"width":"auto", "height":"28px"}} alt="mail icon"/>
			  </a>
